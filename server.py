...
def create_app():
    ...
    app.add_url_rule("/teams/<int:jam_id>", view_func = view.teams_page, methods=["GET"])
    ...
    app.add_url_rule("/viewteam/<int:team_id>", view_func = view.viewteam_page, methods=["GET", "POST"])
